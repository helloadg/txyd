...
public class TestReentrantLockReadWrite {
	...
	public static void main(String[] args) throws InterruptedException{
		final TestReentrantLockReadWrite al = new TestReentrantLockReadWrite();  
...
class StaticLockClassReadWrite{
	public static int i=0;
}