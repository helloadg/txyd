...
public class TestJackson {
    ...
    private TestJackson(){}
    private static class TestJacksonHolder{
        private final static  TestJackson INSTANCE=new TestJackson();
        private final static  ObjectMapper OBJECT_MAPPER=new ObjectMapper();
    }
    public static TestJackson getInstance(){
        return TestJacksonHolder.INSTANCE;
    }
    public static ObjectMapper getObjectMapper(){
        return TestJacksonHolder.OBJECT_MAPPER;
    }
    ...
    public static <T> T json2Pojo(String data, Collection<T> tCollection, Class<T> t) throws Exception {
        ObjectMapper objectMapper = getObjectMapper();
        objectMapper.setPropertyNamingStrategy(PropertyNamingStrategy.CAMEL_CASE_TO_LOWER_CASE_WITH_UNDERSCORES);
        T result = objectMapper.readValue(data, getCollectionType(tCollection.getClass(),t));
        return result;
    }
    ...
    public static void main(String[] args) throws IOException {
        {
            String json = "{\"users\":[{\"id\":0,\"name\":\"txyd0\",\"ch_name\":\"天雪易懂0\"},{\"id\":1,\"name\":\"txyd1\",\"ch_name\":\"天雪易懂1\"}]}";
