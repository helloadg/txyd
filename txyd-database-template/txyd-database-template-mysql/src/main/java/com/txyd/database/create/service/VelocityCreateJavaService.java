...
public class VelocityCreateJavaService extends VelocityCreateBase {
	...
	public static boolean  create(List<DatabaseBean> listDb,JavaConfigBean jcb,Properties properties){
		...
		for(TableBean tb:listDb.get(0).getListTable()){
	        ...
	        Template template = velocityEngine.getTemplate("vm/mapperType/javaService.vm");  
...
//	        System.out.println(writer.toString());
		...
		boolean createFile=VelocityCreateBase.createFile(jcb, fileMap, VelocityCreateBase.FileType.service);
