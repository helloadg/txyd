...
public class DatabaseTypeInterTemplate {
	...
	static{
		...
		model+=" *\n";
		model+=" */\n";
		model+="public enum DatabaseType{\n";
		model+="	all(1,\"all\",\"所有的数据库的类型\"),\n";
		model+="	oracle(2,\"oracle\",\"oracle数据库\"),\n";
		model+="	mysql(3,\"mysql\",\"mysql数据库\"),\n";
		model+="	ms_sql_server(4,\"ms_sql_server\",\"微软sql Server数据库\"),\n";
		model+="	access(5,\"access\",\"微软access数据库\"),\n\n";
		model+="	db2(6,\"access\",\"db2数据库，美国IBM公司开发的一套关系型数据库管理系统\"),\n";
		model+="	informix(7,\"informix\",\"informix数据库，美国IBM公司开发的一套关系型数据库管理系统\");\n";
		model+="	// 成员变量\n";
		...
		model+="\n";
		model+="    // 构造方法\n";
		model+="    private DatabaseType(int index,String name,String comments) {\n";
