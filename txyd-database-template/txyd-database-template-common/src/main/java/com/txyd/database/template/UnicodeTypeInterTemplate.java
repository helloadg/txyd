...
public class UnicodeTypeInterTemplate {
	...
	static{
		...
		model+=" *\n";
		model+=" */\n";
		model+="public enum UnicodeType{\n";
		model+="	utf8(1,\"utf-8\",\"utf-8编码\"),\n";
		model+="	gbk(2,\"gbk\",\"gbk编码\");\n";
		model+="	// 成员变量\n";
		...
		model+="\n";
		model+="    // 构造方法\n";
		model+="    private UnicodeType(int index,String name,String comments) {\n";
